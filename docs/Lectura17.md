...
> **Nota:** Esta sección se añade **sin alterar el contenido anterior**. Completa la guía con decisiones explícitas para evitar drift, interrupciones y comportamientos no deterministas.
