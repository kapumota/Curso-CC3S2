...
En ramas de vida corta es habitual rebasar contra el tronco antes de integrar.  La modalidad interactiva facilita reordenar, combinar con squash o fixup, reescribir mensajes y editar commits. 
Como regla de oro en colaboración, evitar reescribir historia ya publicada.

```bash
# Mantener una rama al día con el tronco sin mezclar commits de fusión
git fetch origin
